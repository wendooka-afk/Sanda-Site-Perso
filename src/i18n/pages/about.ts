export const aboutTexts = {
  fr: {
    ...
    /* ═══════════════════════ CHAPTER 1 ═══════════════════════ */
    chapter1: {
      label: "Chapitre 1 : Là où tout a commencé",
      heading: "Avant l'IA, il y avait un micro et une ambition.",
      p1: "Je viens de Ngaoundéré, dans la région de l'Adamaoua au Cameroun. Pas de Silicon Valley ici. Ni de fonds d'investissement. Encore moins de réseau dans la tech. Juste une conviction : que l'information est le pouvoir, et que celui qui la maîtrise peut tout changer.",
      p2: "C'est cette conviction qui m'a mené au journalisme. Correspondant pour Vision 4 TV depuis 2020 dans la région de l'Adamaoua, j'ai couvert l'actualité sur le terrain. J'ai appris à poser les bonnes questions, à décrypter la complexité, à raconter des histoires qui comptent. Mais très vite, j'ai réalisé quelque chose.",
      quote:
        "\"L'information la plus puissante n'est pas celle qu'on diffuse à la télé. C'est celle qui permet de bâtir quelque chose.\"",
      bold: "Le journalisme m'a donné la rigueur. L'entrepreneuriat m'a donné la liberté. Et l'intelligence artificielle m'a donné le levier pour tout multiplier.",
    },
    ...
    /* ═══════════════════════ CHAPTER 3 ═══════════════════════ */
    chapter3: {
      label: "Chapitre 3 : Quand l'IA a tout changé",
      headingLine1: "L'IA n'est pas arrivée dans ma vie.",
    ...
    /* ═══════════════════════ ECOSYSTEM ═══════════════════════ */
    ecosystem: {
      label: "Chapitre 4 : Ce que je construis aujourd'hui",
      headingLine1: "Un écosystème.",
      headingLine2: "Pas juste une marque personnelle.",
      subtitle: "Aujourd'hui, mon travail repose sur cinq piliers :",
      pillars: [
        {
          title: "WENDOOKA",
          subtitle: "L'Agence",
    ...
    timeline: {
      ...
      subtitle: "De là à ici. Rapidement.",
      events: [
    ...
    /* ═══════════════════════ VALUES ═══════════════════════ */
    values: {
      heading: "MES CONVICTIONS",
      subtitle: "Ce n'est pas juste du business. C'est une vision.",
      items: [
    ...
    vision: {
      label: "OÙ JE VAIS",
      headingLine1: "Ce que je construis",
      headingLine2: "dépasse le business.",
      quote:
  ...
  en: {
    /* ═══════════════════════ SEO ═══════════════════════ */
    seo: {
      title: "About Oumarou Sanda | From Journalism to an AI-Powered Digital Empire",
      description:
    ...
    /* ═══════════════════════ CHAPTER 1 ═══════════════════════ */
    chapter1: {
      label: "Chapter 1: Where It All Started",
      heading: "Before AI, there was a microphone and ambition.",
      p1: "I come from Ngaoundere, in the Adamaoua region of Cameroon. No Silicon Valley here. No venture capital. Not even a network in tech. Just one conviction: information is power, and whoever masters it can change everything.",
      p2: "That conviction led me to journalism. As a correspondent for Vision 4 TV since 2020 in the Adamaoua region, I covered the news on the ground. I learned to ask the right questions, to break down complexity, to tell stories that matter. But very quickly, I realized something.",
      quote:
        "\"The most powerful information isn't what you broadcast on TV. It's the kind that lets you build something.\"",
      bold: "Journalism gave me discipline. Entrepreneurship gave me freedom. And artificial intelligence gave me the leverage to multiply everything.",
    },
    ...
    /* ═══════════════════════ CHAPTER 3 ═══════════════════════ */
    chapter3: {
      label: "Chapter 3: When AI Changed Everything",
      headingLine1: "AI didn't come to me.",
    ...
    /* ═══════════════════════ ECOSYSTEM ═══════════════════════ */
    ecosystem: {
      label: "Chapter 4: What I'm Building Today",
      headingLine1: "An ecosystem.",
      headingLine2: "Not just a personal brand.",
      subtitle: "Today, my work rests on five pillars:",
      pillars: [
        {
          title: "WENDOOKA",
          subtitle: "The Agency",
        ...
        },
        {
          ...
          desc: "Protocole Video IA for video production. Le Cerveau Augmente for productivity. Offshore Empire for international structuring. Books: \"Cerveau Augmente\" (2025) and \"Si l'Afrique rate l'IA, elle rate le Futur\" (2026). Every resource solves a problem and delivers a concrete result.",
        },
        {
          title: "MY CONTENT",
          subtitle: "The Voice",
          desc: "112,000+ subscribers (YouTube, TikTok, Facebook, LinkedIn, Instagram). Correspondent for Vision 4 TV in the Adamaoua region since 2020. I don't create content to entertain. I create content to arm you. Every video, every article, every post is a weapon you can use for your business.",
        },
      ],
    },
    ...
    timeline: {
      ...
      subtitle: "From there to here. Fast.",
      events: [
        { year: "2017", title: "Wendooka Founded", desc: "Launch of the web and digital agency. First clients, first websites, first automations." },
        { year: "2020", title: "Journalism + Content Creation", desc: "Regional correspondent for Vision 4 TV in Adamaoua. Simultaneous launch on YouTube and social media. First videos on digital business and AI." },
        { year: "2022", title: "Audience Explosion", desc: "Passing the 50,000-subscriber mark. Launch of the first online courses." },
    ...
    values: {
      heading: "MY BELIEFS",
      subtitle: "This isn't just business. It's a vision.",
      items: [
    ...
    /* ═══════════════════════ STATS ═══════════════════════ */
    stats: [
      { value: "112,000+", label: "social media subscribers" },
      { value: "200+", label: "entrepreneurs and creators trained" },
      { value: "6+", label: "courses and programs created" },
      { value: "3", label: "companies founded (Wendooka, Sanda Vibe Code, CommentSticker)" },
      { value: "5+", label: "active platforms (YouTube, TikTok, Facebook, LinkedIn, Instagram)" },
    ...
    vision: {
      ...
      headingLine1: "What I'm building",
      headingLine2: "goes beyond business.",
      quote:
        "\"Democratize access to advanced technologies. Turn local skills into global opportunities. Position French-speaking Africa as a credible player in the global digital economy.\"",
      paragraph:
        "My goal isn't to have the biggest subscriber count or the best-selling course. It's to prove something. To prove that an African entrepreneur, armed with the right tools and the right strategy, can compete with anyone on the planet. To prove that technology isn't a luxury reserved for Silicon Valley. Every entrepreneur I help succeed is one more piece of proof that it's possible.",
    ...
    faq: {
      ...
      items: [
        {
          q: "Who is Oumarou Sanda?",
          a: "Oumarou Sanda is a digital entrepreneur, AI expert and trainer based in Cameroon. A correspondent for Vision 4 TV in the Adamaoua region since 2020, he is the founder of Wendooka (web and digital agency), Sanda Vibe Code (vibe coding ecosystem) and CommentSticker (SaaS). Author of two books including \"Si l'Afrique rate l'IA, elle rate le Futur\", he has trained hundreds of African entrepreneurs to use AI for generating revenue, and leads a community of over 112,000 subscribers.",
        },
        {
        ...
        {
          q: "What is Wendooka?",
          a: "Wendooka is a web and digital agency founded by Oumarou Sanda in 2017. Specializing in WordPress, marketing automation and digital solutions, Wendooka helps SMEs, entrepreneurs and organizations grow their online presence and generate concrete results.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes, Oumarou Sanda is based in Ngaoundere, in the Adamaoua region of Cameroon. He operates internationally through his online activities and digital businesses, while staying rooted in the African and French-speaking context.",
        },
      ],
    },
  },
