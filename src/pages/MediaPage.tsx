...
export default function MediaPage() {
  ...
  const shortBio = "Oumarou Sanda est un entrepreneur digital, expert en intelligence artificielle et formateur basé au Cameroun. Fondateur de Wendooka (agence web), Sanda Vibe Code (écosystème IA & no-code) et CommentSticker (SaaS), il a formé plus de 500 entrepreneurs africains et fédère une communauté de 125 000+ abonnés. Correspondant pour Vision 4 TV, il est l'auteur de «Si l'Afrique rate l'IA, elle rate le Futur» (mai 2026).";
  const longBio = "Oumarou Sanda est un entrepreneur digital, expert en intelligence artificielle appliquée et créateur de contenus basé à Ngaoundéré, au Cameroun. Ancien journaliste devenu bâtisseur d'écosystèmes numériques, il est reconnu pour sa capacité à vulgariser des technologies complexes et à les transformer en leviers concrets de croissance, de monétisation et d'impact, en particulier en Afrique francophone.\n\nFondateur de Wendooka (agence web et digitale), Sanda Vibe Code (écosystème dédié au vibe coding et au no-code) et CommentSticker (SaaS), il a créé plusieurs programmes de formation suivis par des centaines d'apprenants, dont le Protocole Vidéo IA, Le Cerveau Augmenté et Offshore Empire. Sa communauté cumulée dépasse 125 000 abonnés sur YouTube, TikTok, Facebook, LinkedIn et Instagram. Correspondant régional pour Vision 4 TV dans l'Adamaoua, il est l'auteur de «Si l'Afrique rate l'intelligence artificielle, elle rate le Futur», un essai-manifeste sur la souveraineté numérique africaine (mai 2026) et de «Le Cerveau Augmenté», un ebook-système pour maîtriser l'IA au quotidien.";

  const faqs = [
    { q: "Qui est Oumarou Sanda ?", a: "Oumarou Sanda est un entrepreneur digital, expert en intelligence artificielle et formateur basé à Ngaoundéré, au Cameroun. Fondateur de Wendooka (agence web), Sanda Vibe Code (écosystème IA et no-code) et CommentSticker (SaaS), il a formé plus de 500 entrepreneurs et fédère 125 000+ abonnés. Correspondant pour Vision 4 TV, il est l'auteur de « Si l'Afrique rate l'IA, elle rate le Futur »." },
    ...
    { q: "Pour quel média travaille Oumarou Sanda ?", a: "Oumarou Sanda est correspondant régional pour Vision 4 TV dans la région de l'Adamaoua au Cameroun. Parallèlement, il est créateur de contenus sur YouTube, TikTok, LinkedIn, Facebook et Instagram avec une audience cumulée de 125 000+ abonnés, spécialisé dans l'intelligence artificielle et le business digital." }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={heroInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="text-left">
              ...
              <p className="text-white/70 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
                Correspondant Vision 4 TV. Créateur suivi par 125 000+ personnes. Auteur de «Si l'Afrique rate l'IA, elle rate le Futur». Formateur de centaines d'entrepreneurs africains. Disponible pour interviews, conférences, panels et collaborations médias.
              </p>
        ...
        <div ref={expertiseRef} className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: Users, title: "Création de contenu & médias", desc: "Construction d'une audience de 125 000+ abonnés en partant de zéro depuis le Cameroun. Stratégies YouTube, TikTok, LinkedIn, monétisation et affiliation." },
