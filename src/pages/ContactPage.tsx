                    ...
                    <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-5">
                      <div className="grid sm:grid-cols-2 gap-5">
                        <div>
                          ...
                          <input type="text" required placeholder="Ex: Jean Dupont" className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] placeholder:text-[#a3a3a3] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all" />
                        </div>
                        <div>
                          <label className="block text-[#a3a3a3] text-xs font-bold uppercase tracking-wider mb-2">Email *</label>
                          <input type="email" required placeholder="jean@entreprise.com" className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] placeholder:text-[#a3a3a3] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all" />
                        </div>
                      </div>
                      <div className="grid sm:grid-cols-2 gap-5">
                        <div>
                          <label className="block text-[#a3a3a3] text-xs font-bold uppercase tracking-wider mb-2">Téléphone / WhatsApp</label>
                          <input type="tel" placeholder="+237 6XX XX XX XX" className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] placeholder:text-[#a3a3a3] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all" />
                        </div>
                        <div>
                          <label className="block text-[#a3a3a3] text-xs font-bold uppercase tracking-wider mb-2">Sujet *</label>
                          <select required className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] outline-none transition-all appearance-none cursor-pointer focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm">
                      ...
                      <div>
                        ...
                        <select className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] outline-none transition-all appearance-none cursor-pointer focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm">
                          <option value="" disabled selected>Pas encore défini</option>
                          <option value="100k">&lt; 100K FCFA</option>
                          <option value="100k-500k">100K - 500K FCFA</option>
                      ...
                      <div>
                        ...
                        <textarea required minLength={20} rows={5} placeholder="Décris ton projet ou ta demande en quelques lignes..." className="w-full bg-[#fafafa] border border-black/10 rounded-xl px-4 py-3.5 text-[#0a0a0a] placeholder:text-[#a3a3a3] focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all resize-none" />
                      </div>
                      <button type="submit" className="w-full py-4 bg-[#0a0a0a] hover:bg-black text-white font-heading font-black rounded-xl hover:shadow-lg transition-all flex items-center justify-center gap-2 text-sm uppercase tracking-wider border border-black/10">
